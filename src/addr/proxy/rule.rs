...
impl Rule {
    pub fn new<'a ,S: Into<&'a str>,S2: Into<String>>(matchs : S,target : S2 ) -> Self {
        let pattern = matchs.into().to_string();
        Self {
...
mod tests {
    ...
    #[test]
    fn test_rule() {
        let rule = Rule::new("https://github.com/galaxy-sec/galaxy-flow*","https://gflow.com");
